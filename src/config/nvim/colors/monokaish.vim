...
" Further edits by Jorge Fuentes
...
hi CursorLineNr ctermfg=45 ctermbg=0 cterm=NONE guifg=#78dce8 guibg=#000000 gui=NONE
...
hi LineNr ctermfg=246 ctermbg=59 cterm=NONE guifg=#999999 guibg=#333333 gui=NONE
...
hi Normal ctermfg=231 ctermbg=16 cterm=NONE guifg=#fcfcfa guibg=#1C1C1C gui=NONE
...
hi Search ctermfg=16 ctermbg=221 cterm=NONE guifg=#2d2a2e guibg=#aa9044 gui=NONE
...
hi SpecialKey ctermfg=240 ctermbg=59 cterm=NONE guifg=#5b595c guibg=#1c1c1c gui=NONE
...
hi Whitespace ctermfg=240 ctermbg=59 cterm=NONE guifg=#444444 guibg=NONE gui=NONE
